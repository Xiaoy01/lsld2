...
!**********************************************************************
    ...
    subroutine generate_matrices(ixname,simparams_double, simparams_int, zmat_offdiag, zdiag_offdiag, &
...
!f2py intent(in) simparams_double
!f2py intent(in) simparams_int
...
!          kzmat(MXDIM+1),zmat(MXEL))
    ...
    integer :: in2, ipdf, ist, igflg, iaflg, irflg, ml, mxy, mzz, lemx, lomx, kmx, mmx, ipnmx, jkmn, jmmn, &
               ...
               nelreo, nelimo, nelred, nelimd, ndimo, ndimo_in, ndimd
...
! read from file:
    ...
    if (fexist .and. (ndimo_in .gt. 0)) then
...
!    write(*,*) 'Ordering potential parameters:'
 !   write(*,*) ipt, lptmx, kptmx
    call matrxo(simparams_double, simparams_int, fad, fgd, lstarts_offdiag, &
                      ...
                      jzmat_offdiag,kzmat_offdiag,nelimo,nelreo,ipt,cpot,lptmx,kptmx)
    call matrxd(simparams_double, simparams_int, fad, fgd, lstarts_diag, &
                      mdjqe1,mdpi1,mdqi1,mdl1,mdjk1,mdk1,mdjm1,mdm1, ndimd, &
                       ...
                       kzmat_diag, nelimd, nelred, ipt,cpot,lptmx,kptmx)
